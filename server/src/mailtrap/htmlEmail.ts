export const htmlContent: string = `
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>&copy; 2025 Copenhagen Eats. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to  Copenhagen Eats!</h1>
                </div>
                <div class="email-body">
                  ...
                  <p>Best Regards,<br/>The Copenhagen Eats Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Copenhagen Eats Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2025 Copenhagen Eats. All rights reserved.</p>
            </div>
